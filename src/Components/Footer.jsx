...
const Footer = () => {
  return (
    <>
      <footer
        className="flex justify-center m-auto mt-[4rem] w-full items-center relative z-10 pt-10 lg:pt-[120px]"
            ...
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="mb-7 text-base text-body-color dark:text-dark-6">
                  we will be the elevator for you that will help you to go high
                </p>
                <p className="flex items-center text-sm font-medium text-dark gap-4 mb-4">
                  <BiPhone className="text-xl" />
                  <a href="tel:+974 6611 6329">+974 6611 6329</a>
                </p>
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="text-base text-body-color dark:text-dark-6">
                  &copy; {new Date().getFullYear()} DesignPro
                </p>
              </div>
            </div>
          </div>
