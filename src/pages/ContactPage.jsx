...
const Form = ({ className }) => {
  ...
  return (
    ...
    >
      ...
      <div id="number-container" className="grid grid-rows-2 mb-4">
        <label
          htmlFor="number"
          className="text-sm flex font-medium text-gray-600"
        >
          Phone Number <span className="text-red-500 text-lg">*</span>
        </label>

        <div id="last-name-container" className="flex">
          <CountryCode
            className={'grid justify-center w-1/3 items-center p-2 mr-2'}
          ...
          <input
            ...
            className="w-20 p-3 border border-r-0 border-gray-300 rounded-l-md"
          />
          <input
            type="number"
            id="number"
            ...
            required
            className="p-3 border border-l-0 border-gray-300 rounded-r-md w-full "
          />
        </div>
      </div>
      ...
      <button
        type="submit"
        className="transition-all duration-300 bg-blue-500 text-white px-4 py-2 rounded-md w-full mt-6 hover:bg-white hover:text-blue-500 border border-gray-300 cursor-pointer "
      >
        Submit
      </button>
    </form>
